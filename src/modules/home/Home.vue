<template>
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center lg:pt-32">
      ...
      >
        ...
        <span class="relative whitespace-nowrap text-blue-600"
          ...
          <span class="relative">My garment</span></span
        >
        <!-- -->
      ...
      <el-dropdown type="primary" class="rounded m-4">
          ...
          <li>
            <ul role="list" class="flex flex-col gap-y-8">
              ...
              <li>
                ...
                <p class="mt-4 text-sm text-slate-700">
                  We only hire our customers, so subscribe for a minimum of 6 months and then let’s
                  talk.
                </p>
              </li>
            </ul>
          ...
          <li>
            <ul role="list" class="flex flex-col gap-y-8">
              ...
              <li>
                ...
                <p class="mt-4 text-sm text-slate-700">
                  This is the power of excellent visual design. You just can’t resist it, no matter
                  how poorly it actually functions.
                </p>
              </li>
              <li>
                <h3 class="font-display text-lg leading-7 text-slate-900">
                ...
                <p class="mt-4 text-sm text-slate-700">
                  Honestly not sure at all. We haven’t actually incorporated or anything, we just
                  thought it sounded cool and made this website.
                </p>
              </li>
            </ul>
          </li>
          <li>
            <ul role="list" class="flex flex-col gap-y-8">
              <li>
                ...
                <p class="mt-4 text-sm text-slate-700">
                  You just tell us what data you need a report for, and we get our kids to create
                  beautiful charts for you using only the finest crayons.
                </p>
              </li>
              <li>
                <h3 class="font-display text-lg leading-7 text-slate-900">
              ...
              <li>
                ...
                <p class="mt-4 text-sm text-slate-700">
                  Send us an email and we will send you a copy of our latest password spreadsheet so
  ...
  <div class="py-10">
    <h2 class="text-5xl mb-5">Pokemon list from API</h2>
    <div class="container grid grid-cols-3 gap-2 mx-auto">
      <div v-for="(item, i) in pokemonList" :key="i" class="w-full rounded">
        <h3>
          {{ item.name }}
        </h3>
      </div>
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const { pokemonList } = storeToRefs(homeStore)
      onMounted(() => {
        homeStore.actGetPokemonList()
      })
      return {
        pokemonList,
      }
